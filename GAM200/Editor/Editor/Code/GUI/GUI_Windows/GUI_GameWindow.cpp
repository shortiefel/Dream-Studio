...
namespace Editor {
	namespace GUI_Windows {
		...
		//		ImGui::Begin("Scene Window", gameWin_bool);
		...
		//		Math::vec3 mousePos{ imousePos.x, imousePos.y, 0.f };
		...
		//		//float determinant; 
		//		//Math::mat3 inverseCamMatrix;
		//		//Math::Inverse(inverseCamMatrix, determinant, camMatrix);
