...
namespace Engine {
    namespace Game {
        ...
        std::list<Math::ivec2> Grid::RetryAStar(Math::ivec2& housePos, Math::ivec2 destPos) {
            bool left = false;
            bool up = false;

            int xVal = housePos.x - offset.x;
            int yVal = housePos.y - offset.y;

            Math::ivec2 tempHousePos = housePos;
