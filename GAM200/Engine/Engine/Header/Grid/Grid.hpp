...
namespace Engine {
	namespace Game {
		...
		public:
			...
			void AStarSearch(Math::vec2(&arr)[MAX_WAYPOINTS], int* count, Math::ivec2(&turnsArr)[MAX_LEFT_TURNS], int* leftArrCount, int* rightArrCount, Math::ivec2* housePos, Math::ivec2 destPos, int routeType);
