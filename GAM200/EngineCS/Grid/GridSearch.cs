...
public class GridSearch
{
    ...
    public static List<Point> AStarSearch(Grid grid, Vector2Int housePoint, Vector2Int destPoint, out int roadCount)
    {
        //grid.PrintGridOut();
        //
        Vector2[] pos2 = new Vector2[100];
        List<Point> path = new List<Point>();
        AStarSearch_Engine(pos2, out int numOfElement2, housePoint, destPoint, out roadCount);
    ...
    internal static extern void AStarSearch_Engine(Vector2[] pos, out int count, Vector2Int housePosition, Vector2Int destPosition, out int roadCount);
