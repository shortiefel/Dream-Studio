...
public class GridSearch
{
    ...
    public static List<Vector2> AStarSearch(Grid grid, out Vector2Int housePoint, Vector2Int destPoint, int routeType, ref List<Vector2Int> leftArray)
    {
        //grid.PrintGridOut();
        //
        Vector2[] pos2 = new Vector2[100];
        Vector2Int[] leftArr = new Vector2Int[33];
    ...
    internal static extern void AStarSearch_Engine(Vector2[] pos, out int count, Vector2Int[] pos2, out int count2, out Vector2Int housePosition, Vector2Int destPosition, int routeType);
