...
; !!NOTE!!: Replace all instances of "Dream_Engine" with your game name.
AppName=Dream_Engine
AppVerName=Dream_Engine Version 0.1
...
DefaultDirName={pf}\DigiPen\Dream_Engine

; Start menu directory
DefaultGroupName=DigiPen\Dream_Engine

; Output directory for the installer.
OutputDir=.\INSTALLER

; Setup executable installer
OutputBaseFilename=Dream_Engine_Setup
...
[Icons]
Name: {group}\Dream_Engine; Filename: {app}\Dream_Engine.exe; WorkingDir: {app}; IconFilename: "{app}\Icon.ico"
Name: {group}\{cm:UninstallProgram,Dream_Engine}; Filename: {uninstallexe}
Name: {commondesktop}\Dream_Engine; Filename: {app}\Dream_Engine.exe; Tasks: desktopicon; WorkingDir: {app}; IconFilename: "{app}\Icon.ico"
...
Filename: {app}\Dream_Engine.exe; Description: {cm:LaunchProgram,Dream_Engine}; Flags: nowait postinstall skipifsilent
